...
int main(int argc, char *argv[])
{
    ...
    QLabel MyLable("<A href = \"https://doc.qt.io/qt-5/qspinbox.html\"> QSpinbox </A>", nullptr, Qt::WindowFlags(Qt::WindowStaysOnTopHint));
    MyLable.setOpenExternalLinks(true);
    ...
    txtArea_1->setPlainText(txtArea_2->toPlainText() + "\ntext lorem ipsum for editor one");
    txtArea_2->setPlainText(txtArea_2->toPlainText() + "\ntext lorem ipsum for editor two");
    spl->show();
